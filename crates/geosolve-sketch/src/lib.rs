...
pub use document::{
    ActivationDigest, ContactAdmissibleRange, ContactAdmissibleRangeEdit, ContactBranchEdit,
    ...
    DocumentCurveControl, DocumentCurveControlAvailability, DocumentCurveControlError,
    ...
    DocumentDirectionRef, DocumentDirectionSense, DocumentElementActivity, DocumentElementId,
    DocumentEndpointRef, DocumentError, DocumentExternalBinding, DocumentExternalBindingId,
    ...
    DocumentObjectRelabel, DocumentOffsetTraversal, DocumentParameter, DocumentParameterBinding,
    DocumentParameterId, DocumentParameterKind, DocumentParameterOutput, DocumentParameterTarget,
    DocumentPointRef, DocumentProfileOffsetChain, DocumentProfileOffsetEdgePair,
    DocumentProfileOffsetIds, DocumentProfileOffsetJunction, DocumentProfileOffsetJunctionBranch,

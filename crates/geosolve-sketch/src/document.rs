...
use query::{
    angular_target_difference, conic_ratio_domain, conic_weight_domain, curve_owned_scalars,
    document_bspline_curve_error, document_conic_geometry_document_error,
    document_curve_conic_geometry_error, document_nurbs_curve_error,
    document_query_conic_geometry_error, document_trim_projection_geometry_error,
    finite_query_point, indexed_point, is_conic_definition, push_axis_controls, push_curve_control,
    push_trim_controls, require_trim_scalar,
};

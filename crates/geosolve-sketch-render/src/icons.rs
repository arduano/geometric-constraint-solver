...
#[cfg(test)]
pub const GEOMETRY_TOOLS: [(&str, EditorTool); 15] = [
...
pub const fn geometry_tool_key(tool: EditorTool) -> &'static str {
    match tool {
...
pub fn geometry_tool_icon_markup(tool: EditorTool) -> String {
...
pub fn geometry_variant_icon_markup(variant: GeometryToolVariant) -> String {
...
pub fn construction_role_icon_markup() -> String {
    format!(
...
pub fn tree_icon_markup(kind: TreeIconKind) -> String {
...
pub const PROBLEM_ICON: &str = "<path class=\"wb-error-marker-icon\" d=\"M0-6V1M0 5v.2\"/>";

pub const fn constraint_icon_key(glyph: SceneConstraintGlyph) -> &'static str {
    match glyph {
...
pub const fn constraint_icon_fragment(glyph: SceneConstraintGlyph) -> &'static str {
    match glyph {
        SceneConstraintGlyph::Fixed => FIXED,
        SceneConstraintGlyph::Coincident => COINCIDENT,
        SceneConstraintGlyph::Horizontal => HORIZONTAL,
...
pub fn authoring_icon_markup(tool: AuthoringTool) -> String {
...
pub fn feature_icon_markup(tool: FeatureAuthoringTool) -> String {
    let (key, fragment) = match tool {
...
pub fn offset_icon_markup() -> String {
    format!(

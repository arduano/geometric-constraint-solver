...
`channel.json` and `manifold.json` are outputs of the TypeScript SDK runtime recorder.
The manifold executes the source-authored water manifold and its local

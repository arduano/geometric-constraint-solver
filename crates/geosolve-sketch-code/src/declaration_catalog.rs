...
pub const CODE_DECLARATION_FAMILIES: [CodeDeclarationFamilyDescriptor; 17] = [
    ...
    CodeDeclarationFamilyDescriptor {
        family: "constraint.symmetricAboutDatumAxis",
        direct: Some(DirectDeclarationLowering::Constraint(
            ConstraintKind::SymmetricAboutDatumAxis,
        )),
        template: None,
        native: NativeDeclarationContract::Constraint(ConstraintKind::SymmetricAboutDatumAxis),
    },
    CodeDeclarationFamilyDescriptor {
    ...
    CodeDeclarationFamilyDescriptor {
        family: "dimension.radius",
        direct: Some(DirectDeclarationLowering::Dimension(DimensionKind::Radius)),
        template: Some(TemplateDeclarationLowering::Dimension(
            DimensionKind::Radius,
        )),
        native: NativeDeclarationContract::Dimension(DimensionKind::Radius),
    },
    CodeDeclarationFamilyDescriptor {
...
pub fn declaration_result_catalog() -> BTreeMap<String, CodeDeclarationResultDescriptor> {
    BTreeMap::from([
        ...
        (
            "constraint.symmetricAboutDatumAxis".into(),
            descriptor_kind(FeatureKind::Constraint, leaf(FeatureKind::Constraint)),
        ),
        (

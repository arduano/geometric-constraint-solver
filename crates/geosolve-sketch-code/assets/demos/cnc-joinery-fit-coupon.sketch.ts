...
export default sketch(($) => {
  ...
  const looseMortiseBottom = $.constraint.horizontal("looseMortiseBottom", {
    span: looseMortise.segments.byKey.lowerLeft,
  });
  const looseMortiseRight = $.constraint.vertical("looseMortiseRight", {
    span: looseMortise.segments.byKey.lowerRight,
  });
  const looseMortiseTop = $.constraint.horizontal("looseMortiseTop", {
    span: looseMortise.segments.byKey.upperRight,
  });
  const looseMortiseLeft = $.constraint.vertical("looseMortiseLeft", {
    span: looseMortise.segments.byKey.upperLeft,
  });
  const looseMortiseWidth = $.dimension.curveLength("looseMortiseWidth", {
    curve: looseMortise.segments.byKey.lowerLeft,
    value: mm(70),
  });
  const looseMortiseHeight = $.dimension.curveLength("looseMortiseHeight", {
    curve: looseMortise.segments.byKey.lowerRight,
    value: mm(18.4),
  });
  ...
  const nominalMortiseBottom = $.constraint.horizontal("nominalMortiseBottom", {
    span: nominalMortise.segments.byKey.lowerLeft,
  });
  const nominalMortiseRight = $.constraint.vertical("nominalMortiseRight", {
    span: nominalMortise.segments.byKey.lowerRight,
  });
  const nominalMortiseTop = $.constraint.horizontal("nominalMortiseTop", {
    span: nominalMortise.segments.byKey.upperRight,
  });
  const nominalMortiseLeft = $.constraint.vertical("nominalMortiseLeft", {
    span: nominalMortise.segments.byKey.upperLeft,
  });
  const nominalMortiseWidth = $.dimension.curveLength("nominalMortiseWidth", {
    curve: nominalMortise.segments.byKey.lowerLeft,
    value: mm(70),
  });
  const nominalMortiseHeight = $.dimension.curveLength("nominalMortiseHeight", {
    curve: nominalMortise.segments.byKey.lowerRight,
    value: mm(18),
  });
  ...
  const pressMortiseBottom = $.constraint.horizontal("pressMortiseBottom", {
    span: pressMortise.segments.byKey.lowerLeft,
  });
  const pressMortiseRight = $.constraint.vertical("pressMortiseRight", {
    span: pressMortise.segments.byKey.lowerRight,
  });
  const pressMortiseTop = $.constraint.horizontal("pressMortiseTop", {
    span: pressMortise.segments.byKey.upperRight,
  });
  const pressMortiseLeft = $.constraint.vertical("pressMortiseLeft", {
    span: pressMortise.segments.byKey.upperLeft,
  });
  const pressMortiseWidth = $.dimension.curveLength("pressMortiseWidth", {
    curve: pressMortise.segments.byKey.lowerLeft,
    value: mm(70),
  });
  const pressMortiseHeight = $.dimension.curveLength("pressMortiseHeight", {
    curve: pressMortise.segments.byKey.lowerRight,
    value: mm(17.6),
  });
  ...
  const blankToStationXHorizontal = $.constraint.horizontal("blankToStationXHorizontal", {
    span: blankToStationX.span,
  });
  const blankToStationXLength = $.dimension.curveLength("blankToStationXLength", {
    curve: blankToStationX.span,
    value: mm(25),
  });
  ...
  const pressMortiseYLength = $.dimension.curveLength("pressMortiseYLength", {
  ...
  const pressToNominalMortiseVertical = $.constraint.vertical("pressToNominalMortiseVertical", {
    span: pressToNominalMortise.span,
  });
  const pressToNominalMortiseLength = $.dimension.curveLength("pressToNominalMortiseLength", {
    curve: pressToNominalMortise.span,
    value: mm(41.8),
  });
  ...
  const nominalToLooseMortiseVertical = $.constraint.vertical("nominalToLooseMortiseVertical", {
    span: nominalToLooseMortise.span,
  });
  const nominalToLooseMortiseLength = $.dimension.curveLength("nominalToLooseMortiseLength", {
    curve: nominalToLooseMortise.span,
    value: mm(41.8),
  });
  ...
  const nominalStationWidthHorizontal = $.constraint.horizontal("nominalStationWidthHorizontal", {
    span: nominalStationWidth.span,
  });
  const nominalStationWidthLength = $.dimension.curveLength("nominalStationWidthLength", {
    curve: nominalStationWidth.span,
    value: mm(125),
  });
  ...
  const pressToNominalTabVertical = $.constraint.vertical("pressToNominalTabVertical", {
    span: pressToNominalTab.span,
  });
  const pressToNominalTabLength = $.dimension.curveLength("pressToNominalTabLength", {
    curve: pressToNominalTab.span,
    value: mm(42),
  });
  ...
  const nominalToLooseTabVertical = $.constraint.vertical("nominalToLooseTabVertical", {
    span: nominalToLooseTab.span,
  });
  const nominalToLooseTabLength = $.dimension.curveLength("nominalToLooseTabLength", {
    curve: nominalToLooseTab.span,
    value: mm(42),
  });
  ...
  return {
    femaleBlank: femaleBlank,
    looseMortise: looseMortise,
    nominalMortise: nominalMortise,
    pressMortise: pressMortise,

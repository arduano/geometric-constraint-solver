...
export default sketch(($) => {
  ...
  const feedAxis = $.constraint.horizontal("feedAxis", {
    span: feed.span,
  });
  const riseAxis = $.constraint.vertical("riseAxis", {
    span: rise.span,
  });
  const bridgeAxis = $.constraint.horizontal("bridgeAxis", {
    span: bridge.span,
  });
  const stackAxis = $.constraint.vertical("stackAxis", {
    span: stack.span,
  });

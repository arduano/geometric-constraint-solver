...
export default sketch(($) => {
  ...
  $.group("Construction datums", [reservoirInsetX, reservoirInsetY, lowerOutletDatum, middleOutletDatum, upperOutletDatum, upperSealInsetX, upperSealInsetY, middleSealInsetX, middleSealInsetY, lowerSealInsetX, lowerSealInsetY, topScrewInset, topScrewRail0, topScrewRail1, topScrewRail2, topScrewRail3, bottomScrewInset, bottomScrewRail0, bottomScrewRail1, bottomScrewRail2, bottomScrewRail3]);
  $.group("Acrylic manifold", [plate, reservoir, upperCenterline, upperSeal, middleCenterline, middleSeal, lowerCenterline, lowerSeal, screwNwOuter, screwNwInner, screwNeInner, screwNeOuter, screwSwOuter, screwSwInner, screwSeInner, screwSeOuter]);
  return {
    plate: plate,
    reservoir: reservoir,
    upperCenterline: upperCenterline,
    upperSeal: upperSeal,
    upperChannelBends: upperChannelBends,
    middleCenterline: middleCenterline,
    middleSeal: middleSeal,
    middleChannelBends: middleChannelBends,
    lowerCenterline: lowerCenterline,
    lowerSeal: lowerSeal,
    lowerChannelBends: lowerChannelBends,
    screwNwOuter: screwNwOuter,
    screwNwInner: screwNwInner,
    screwNeInner: screwNeInner,
    screwNeOuter: screwNeOuter,
    screwSwOuter: screwSwOuter,
    screwSwInner: screwSwInner,
    screwSeInner: screwSeInner,
    screwSeOuter: screwSeOuter,

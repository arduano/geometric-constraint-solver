...
The implementation checkpoint contains the singular manifest-driven 20-sample registry in canonical
`5 mechanisms / 11 products and fabrication studies / 2 reference atlases / 2 scale studies`
...
registry and drift fails qualification.

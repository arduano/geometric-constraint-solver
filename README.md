...
3. `PLAN.md` — active roadmap: completed M8-M52, active human M53 and placeholder M100X-M109X.
...
and application undo. Human UAT occurs at completed M40.7, post-cleanup M53 and
placeholder M106X/M108X; all objective behavior is directly automated first. The desktop demo has no future mobile
support requirement.

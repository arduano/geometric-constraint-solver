...
Fillet-hidden construction provenance and headless role-aware picking. M70 is an empty unscoped
placeholder.
...
3. `PLAN.md` — active roadmap: completed and approved through M69, with M70 awaiting scope.

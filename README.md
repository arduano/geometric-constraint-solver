...
3. `PLAN.md` — active roadmap: completed M8-M56 and executable M57-M64, with M57 active.
...
- `geosolve-sketch` — persistent sketch entities, conics, non-rational B-splines, generic constraints and compilation into core residuals, with reusable accepted-only and retained-design lifecycle/serialization APIs plus host-scheduled prepared jobs and exact-input compare-and-swap publication.

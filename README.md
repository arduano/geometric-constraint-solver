...
3. `PLAN.md` — active roadmap: completed and approved through M64, with the mechanically
   qualified M65 candidate awaiting focused UAT.
...
and application undo. Human UAT is complete at M40.7, M53 and M61-M64; every newly scoped
milestone ends in its own UAT and all objective behavior is directly automated first. The desktop
demo has no future mobile support requirement.

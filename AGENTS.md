...
- Keep `geosolve-demo-web` as a separate WASM crate. It must consume public domain APIs rather than duplicating solver equations.
...
- Every residual implementation needs a finite-difference Jacobian test.

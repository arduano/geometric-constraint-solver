...
is claimed by that automation alone. The supervising user's later milestone-level decision accepts
...
On 2026-08-27 the supervising user approved M84 and asked for the milestone to be closed before

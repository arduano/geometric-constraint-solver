...
9. Run focused catalog, identity, migration, policy, RPC and workbench tests; run the unchanged
   baseline and complete release gate; nominate one immutable Tailscale build for human UAT.

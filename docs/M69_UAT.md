...
All seven served assets and `/` were fetched over the preview endpoint and compared byte-for-byte
...
On 2026-08-09, the maintainer explicitly accepted the focused M69 candidate and requested

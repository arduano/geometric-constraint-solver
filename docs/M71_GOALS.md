...
Status: temporary backlog only. M71 is neither active nor ordered and is not scoped or authorized
for implementation.

M70 deliberately proves auto-constraint interaction using constraint definitions already admitted
...
ADR/schema work and define its own direct gate and end-of-milestone UAT.

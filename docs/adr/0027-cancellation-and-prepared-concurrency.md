...
M56 implements immutable accepted snapshots, prepared jobs, candidate patches and
...
the maximum observed cancellation latency at their boundaries. M57 may improve those
...
M56 separates preparation, execution and commit:
...
At M56, immutable accepted snapshots, prepared jobs, cancellation handles/tokens and
...
- M35 must instrument all documented expensive paths before claiming cancellation;
  M56 must prove ownership markers and stale-commit behavior before claiming prepared
  concurrency.

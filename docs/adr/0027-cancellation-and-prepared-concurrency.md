...
M55 implements immutable accepted snapshots, prepared jobs, candidate patches and
...
the maximum observed cancellation latency at their boundaries. M56 may improve those
...
M55 separates preparation, execution and commit:
...
At M55, immutable accepted snapshots, prepared jobs, cancellation handles/tokens and
...
- M35 must instrument all documented expensive paths before claiming cancellation;
  M55 must prove ownership markers and stale-commit behavior before claiming prepared
  concurrency.

...
Status: accepted and implemented for active M82; final clean nomination and human acceptance pending
...
actually pass, and `docs/M82_UAT.md` remains pending until an exact frozen candidate exists.

...
M49 implements `geosolve-sketch-ops`. M50 implements
...
M49 owns general split/break, trim, extend, exact family-supported mirror, chamfer,
...
M55 contract; an unsupported exact transformation returns a typed unsupported outcome
...
M50 query contract. It uses distinct result types and requires full resolution of the
...
- Separate crates add packaging and API surface, but make forbidden dependency and
  ownership edges mechanically reviewable at M49 and M50.

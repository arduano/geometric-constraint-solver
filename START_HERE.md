...
adds cooperative cancellation and deterministic operation control. M36 now adds the
closed typed operand and scalar foundations required by the ordinary CAD catalog.
M37 catalog behavior remains planned.

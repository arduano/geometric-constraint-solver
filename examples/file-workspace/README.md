...
Follow [Getting started](../../docs/GETTING_STARTED.md) to prepare the checkout,
then create a new editable project:
...
The CLI also supports an offline installation from four matching package archives;
see its [installation instructions](../../packages/geosolve-cli/README.md).
The bridge listens on loopback. For a different machine, forward its printed port
with SSH and open the same local URL/token.

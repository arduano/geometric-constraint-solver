...
try {
  ...
  for (const method of ["export class SketchEngine", "evaluateGenerated(", "evaluateManaged(", "exportProfiles(", "releaseResult(", "prepareEditableAuthoring(", "applyEditableAuthoring(", "releaseEditableAuthoring(", "exportEditableProject(", "editableSourceDesignDigest(", "editablePointGestureTargets(", "beginEditablePointGesture(", "advanceEditablePointGesture(", "editablePointGestureScene(", "editablePointGesturePresentation(", "finishEditablePointGesture(", "cancelEditablePointGesture(", "prepareEditablePointCommit(", "applyEditablePointCommit(", "releaseEditablePointCommit(", "beginEditableConstruction(", "advanceEditableConstruction(", "editableConstructionScene(", "editableConstructionPresentation(", "finishEditableConstruction(", "cancelEditableConstruction(", "prepareEditableConstruction(", "resolveEditableConstruction(", "applyEditableConstructionCommit(", "releaseEditableConstruction("]) if (!declarations.includes(method)) throw Error(`Missing native contract: ${method}`);

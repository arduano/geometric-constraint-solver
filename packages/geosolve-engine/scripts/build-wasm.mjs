...
try {
  ...
  for (const method of ["editableCompilerPatches(", "exportResultWorkspace(", "encodeReproduction(", "editableInteractionSeed(", "resultInteractionSeed(", "restoreEditableWorkspace(", "exportEditableWorkspace(", "restoreEditableHistory(", "exportEditableHistory(", "inspectEditableSession(", "editableToolOperationViewOperands(", "editableToolOperationContext(", "editableToolOperationOperands(", "beginEditableToolOperation(", "advanceEditableToolOperation(", "editableToolOperationPresentation(", "finishEditableToolOperation(", "cancelEditableToolOperation(", "prepareEditableToolOperation(", "prepareEditableToolOperationReplay(", "resolveEditableToolOperation(", "applyEditableToolOperationCommit(", "releaseEditableToolOperation("]) {
    if (!declarations.includes(method)) throw Error(`Missing native tool contract: ${method}`);
  }
  for (const method of ["export class SketchEngine", "evaluateGenerated(", "evaluateManaged(", "exportProfiles(", "releaseResult(", "prepareEditableAuthoring(", "applyEditableAuthoring(", "releaseEditableAuthoring(", "exportEditableProject(", "editableSourceDesignDigest(", "editablePointGestureTargets(", "beginEditablePointGesture(", "advanceEditablePointGesture(", "editablePointGestureScene(", "editablePointGesturePresentation(", "finishEditablePointGesture(", "cancelEditablePointGesture(", "prepareEditablePointCommit(", "prepareEditablePointReplay(", "applyEditablePointCommit(", "releaseEditablePointCommit(", "beginEditableConstruction(", "advanceEditableConstruction(", "editableConstructionScene(", "editableConstructionPresentation(", "finishEditableConstruction(", "cancelEditableConstruction(", "prepareEditableConstruction(", "prepareEditableConstructionReplay(", "resolveEditableConstruction(", "applyEditableConstructionCommit(", "releaseEditableConstruction("]) if (!declarations.includes(method)) throw Error(`Missing native contract: ${method}`);

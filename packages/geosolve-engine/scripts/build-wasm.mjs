...
try {
  ...
  for (const method of ["export class SketchEngine", "evaluateGenerated(", "evaluateManaged(", "exportProfiles(", "releaseResult("]) if (!declarations.includes(method)) throw Error(`Missing native contract: ${method}`);

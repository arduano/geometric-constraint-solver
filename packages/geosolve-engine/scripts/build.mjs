...
await build({ entryPoints: [resolve(root, "src/index.ts")], outfile: resolve(root, "dist/index.js"), bundle: true, format: "esm", platform: "neutral", target: "es2022", external: ["@geosolve/sketch-code"] });
...
const options = { declaration: true, emitDeclarationOnly: true, strict: true, target: ts.ScriptTarget.ES2022,
  ...
  paths: { "@geosolve/sketch-code": [resolve(root, "../geosolve-sketch-code/dist/src/index.d.ts")] },
};

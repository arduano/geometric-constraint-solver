...
const packageRoot = resolve(root, "packages/geosolve-collaboration");
...
run("cargo", ["build", "--locked", "-p", "geosolve-collaboration-wasm", "--target", "wasm32-unknown-unknown", ...(release ? ["--release"] : [])]);
